...
function heart_pressed() {
    ...
    if (this.dataset.userId == "null"){
        ...
        $.post("./favoriteController.jsp", { game_id: this.dataset.gameId, user_id: this.dataset.userId, action: "add" });
        ...
        $.post("./favoriteController.jsp", { game_id: this.dataset.gameId, user_id: this.dataset.userId, action: "remove" });
    }
}