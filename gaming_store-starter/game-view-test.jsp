	...
	<body>
		<div id="allbody">
			...
			<div class="agileinfo-dot">
				<a class="logo" href="<%=request.getContextPath() %>/FindYourGame/index.jsp"> <img src="<%=request.getContextPath() %>/FindYourGame/images/logo.png"></a>
			...
			<section class ="game-details">
				...
				<div class="section-content">
                    ...
                    <div id="short-description" class="second-column">
                    ...
                    <div id="long-description" class="second-column">
                    ...
                    <div class="rate-area second-column" id="rate">
                    ...
                    <div class="comment-area second-column" id="com">
                        <h2 class="comments-ratings-head">
